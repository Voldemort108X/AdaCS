...
class Miccai2021_LDR_conditional_laplacian_unit_disp_add_lvl1(nn.Module):
    def __init__(self, in_channel, n_classes, start_channel, is_train=True, imgshape=(128, 128), range_flow=0.4):
        ...
        self.transform = SpatialTransformer(self.imgshape).cuda()
    ...
    def forward(self, x, y, reg_code):
        ...
        warpped_inputx_lvl1_out = self.transform(x, output_disp_e0_v)
...
class Miccai2021_LDR_conditional_laplacian_unit_disp_add_lvl2(nn.Module):
    def __init__(self, in_channel, n_classes, start_channel, is_train=True, imgshape=(128, 128), range_flow=0.4, model_lvl1=None):
    ...
    def forward(self, x, y, reg_code):
        ...
        warpped_x = self.transform(x_down, lvl1_disp_up)
        ...
        warpped_inputx_lvl1_out = self.transform(x, compose_field_e0_lvl1)
...
class Miccai2021_LDR_conditional_laplacian_unit_disp_add_lvl3(nn.Module):
    ...
    def forward(self, x, y, reg_code):
        ...
        warpped_x = self.transform(x, lvl2_disp_up)
